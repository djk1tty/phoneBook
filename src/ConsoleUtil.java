    ...
    public static int inputInt(String message, int min, int max) {
        ...
        do {
            try {
                ...
                System.out.println("Ошибка. Вы ввели число или число за пределами диапозона от " + min + "до " + max);
            }
    ...
    public static String inputString(String message, int minLength, int maxLength) {
        ...
        do {
            try {
                ...
                System.out.println("Ошибка. Длина вашей строки должна быть от " + minLength + "до " + maxLength);
            }

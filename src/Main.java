public class Main {
    public static void main(String[] args) throws Exception {
        ...
        while (isRun) {
            ...
            ConsoleUtil.printlnString("2. Сохранить список в файл");
            ...
            switch (action) {
                ...
                break;
                case 3: {
                    String model = ConsoleUtil.inputString("Введите модель теелфона.", 3, 20);
                    String color = PhoneColors.getColorByNumber(ConsoleUtil.inputInt("Введите номер цвета (1,2,3):", 3, 20));
                    int price = ConsoleUtil.inputInt("Цену телефона", 1, 1000000000);
